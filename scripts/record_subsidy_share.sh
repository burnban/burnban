...
sed "s/2026-07-11T22:00:00Z/$timestamp/" \
  testdata/subsidy-share/claude/demo.jsonl >"$tmp/fixture/claude/demo.jsonl"
...
asciinema record \
  ...
  --title "burnban subsidy --share · deterministic fixture" \
  --command ./scripts/subsidy_share_demo.sh \
  "$cast"
